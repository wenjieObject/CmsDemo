...
namespace Czar.Cms.Controllers
{
    ...
    {
        private IManagerRoleRepository ManagerRoleRepository;
        ...
        public Task<IActionResult> GetEntities()
        {
            ...
            {
                    var rows = ManagerRoleRepository.Get().ToList();
        ...
        public Task<IActionResult> GetEntitiesByPaged(int pageSize, int pageIndex)
        {
            return Task.Factory.StartNew<IActionResult>(() =>
            {
                var total = ManagerRoleRepository.Count(m => true);
                var rows = ManagerRoleRepository.GetByPagination(m => true, pageSize, pageIndex, true,
                    m => m.Id).ToList();
        ...
        public Task<IActionResult> Add(ManagerRole model)
        {
            return Task.Factory.StartNew<IActionResult>(() =>
            {
                if(!ModelState.IsValid)
                    return Json(ExcutedResult.FailedResult("数据验证失败"));
                ManagerRoleRepository.AddAsync(model, false);
        ...
        public Task<IActionResult> Delete(int id)
        {
            return Task.Factory.StartNew<IActionResult>(() =>
            {
                ManagerRoleRepository.Delete(id, false);
